# Generated by Django 2.2.16 on 2022-05-11 15:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='role',
            field=models.CharField(choices=[('UR', 'user'), ('MD', 'moderator'), ('AD', 'admin')], default='UR', max_length=2, unique=True, verbose_name='Роль пользователя'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
